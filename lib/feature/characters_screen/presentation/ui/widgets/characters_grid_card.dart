...
class CharactersGridCard extends StatelessWidget {
  final CharactersDataEntity data;
  final bool isPlaceholder;
  const CharactersGridCard(
      {super.key, required this.data, this.isPlaceholder = false});

  factory CharactersGridCard.placeholder() {
    return const CharactersGridCard(
      isPlaceholder: true,
        ...
        children: [
          ...
          ShimmerPlaceholder(
            ...
            child: Text(
              ...
              style:
                  theme.typography.s12w400.copyWith(color: theme.colors.grey),
            ),
          )
        ],
      ),
